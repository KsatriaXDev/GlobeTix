...
import React from 'react'
import Link from 'next/link';
import ImageDetails, {ImageDetails1} from './components/molecules/ImageDetails'
...
export  function Details1() {
  return (
    ...
    <figcaption>
      ...
      <section className="featured" id="featured">
        <h1 className="heading_">Candi Borobudur <span className="text-blue-800">"Monumen Nasional 'MONAS' "</span></h1>
